...
def asignar_longitud(LONG_PALABRA_MIN,mas_larga):
    ...
    de la palabra a elegir; en caso afirmativo, se pregunta cual es la longitud deseada entre los valores establecidos como minimo y 
    maximo. Y en caso negativo, se toma un numero al azar entre el minimo y maximo.
